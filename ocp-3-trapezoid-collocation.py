...
v_h2_dot = thank_model(ca.if_else(i_el>I_e_std, f_h2, 0), HydrogenDemand(time)) # Hydrongen volume rate in the tank (Nm3/min)
...
f_l = (p_el - p_ps)**2
f_l += f_l - X[-1]*4e12 # Add terminal cost
...
opts = {
    "ipopt.output_file" : ipopt_log_file,
    "ipopt.print_level" : 0,
