...
# NLP solver options
opts = {"ipopt.output_file" : "results/ocp-2-multiple-shooting.txt"}
...
optimzation_status = ''
with open('results/ocp-2-multiple-shooting.txt') as file:
    for line in file:
...
plt.savefig('results/ocp-2-multiple-shooting.png', bbox_inches='tight', dpi=300)