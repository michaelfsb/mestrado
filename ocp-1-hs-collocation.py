...
# Plot results
f_x_opt = interpolate.InterpolatedUnivariateSpline(t, x_opt, k=3) # k=2 is a quadratic spline
f_u_opt = interpolate.InterpolatedUnivariateSpline(t, u_opt, k=2) # k=1 is a linear spline
